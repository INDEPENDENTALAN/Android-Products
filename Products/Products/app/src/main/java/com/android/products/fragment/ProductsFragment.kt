...
class ProductsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity!!.getSharedPreferences("Products", AppCompatActivity.MODE_PRIVATE).getInt("product", -1) == 1) {
            //
            editText_name.setText(activity!!.intent.getStringExtra("name"))
            editText_price.setText(activity!!.intent.getStringExtra("price"))
            editText_details.setText(activity!!.intent.getStringExtra("details"))
            //imageView_image.setImageBitmap(onStringToBitmap(activity!!.intent.getStringExtra("image")))
        }
