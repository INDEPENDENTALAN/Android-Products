...
class ProductsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //
        textView_products
        this.supportFragmentManager.beginTransaction().replace(R.id.frameLayout_products, HomeFragment()).commit()
        //
        ...
        view.button_products_sign_out.setOnClickListener { l: View? ->
            //
            getSharedPreferences("Accounts", MODE_PRIVATE).edit().putInt("sign", 1).apply()
            recreate()
        }
        //
